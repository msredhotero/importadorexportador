...
--
-- Servidor: localhost
-- Tiempo de generación: 19-12-2014 a las 17:21:27
...
--
-- Volcado de datos para la tabla `cv_detallefacturas`
--

INSERT INTO `cv_detallefacturas` (`iddetallefactura`, `reffactura`, `refproducto`, `precioventa`, `cantidad`) VALUES
(4, 3, 4, '0', 2),
(5, 3, 6, '0', 3),
(7, 4, 6, '0', 3);
...
--
-- Estructura de tabla para la tabla `cv_estadoenvio`
--

CREATE TABLE IF NOT EXISTS `cv_estadoenvio` (
  `idestadoenvio` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Volcado de datos para la tabla `cv_estadoenvio`
--

INSERT INTO `cv_estadoenvio` (`idestadoenvio`, `estado`, `icono`) VALUES
(8, 'En Proceso', 'imagenes/estados/three115.png'),
(2, 'Preparando el Pedido', 'imagenes/estados/packages2.png'),
(3, 'Despachado', 'imagenes/estados/logistics3.png'),
(4, 'Recibido', 'imagenes/estados/check6.png'),
(5, 'Cancelado', 'imagenes/estados/times1.png'),
(6, 'Devuelto', 'imagenes/estados/moving1.png'),
(7, 'Demorado', 'imagenes/estados/delivery25.php');
...
--
-- Volcado de datos para la tabla `cv_facturas`
--

INSERT INTO `cv_facturas` (`idfactura`, `nrofactura`, `fechacreacion`, `refcliente`, `domicilio`, `cancelado`) VALUES
(3, 'CAC0000001', '2014-12-19 11:12:43', 9, '45 nº1523 e/23 y 24', b'0'),
(4, 'CAC0000004', '2014-12-19 11:12:14', 9, '45 nº1523 e/23 y 24', b'0');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `cv_pedidos`
--

CREATE TABLE IF NOT EXISTS `cv_pedidos` (
  `idpedido` int(11) NOT NULL AUTO_INCREMENT,
  `reffactura` int(11) NOT NULL,
  `refestado` smallint(6) NOT NULL,
...
--
-- Volcado de datos para la tabla `cv_pedidos`
--

INSERT INTO `cv_pedidos` (`idpedido`, `reffactura`, `refestado`, `fechacreacion`, `fechamodificacion`, `refusuario`) VALUES
(3, 3, 4, '2014-12-19 11:12:43', '2014-12-19 11:12:43', 9),
(4, 4, 4, '2014-12-19 11:12:14', '2014-12-19 11:12:14', 9);
...
--
-- Volcado de datos para la tabla `se_roles`
--

INSERT INTO `se_roles` (`idrol`, `descripcion`) VALUES
(1, 'Administrador'),
(2, 'Cliente'),
(3, 'Empleado');
...
CREATE TABLE IF NOT EXISTS `se_usuarios` (
  ...
  `intentoserroneos` smallint(6) DEFAULT NULL,
...
INSERT INTO `se_usuarios` (`idusuario`, `apellido`, `password`, `refroll`, `email`, `nombre`, `telefono`, `direccion`, `imagen`, `mime`, `carpeta`, `intentoserroneos`) VALUES
(8, 'marcos', 'marcos', 1, 'msredhotero@msn.com', 'Saupurein Marcos', NULL, NULL, NULL, NULL, NULL, NULL),
(9, 'Ramirez', 'pato', 2, 'pato@msn.com', 'Patricia', '', '45 nº1523 e/23 y 24', '', '', '', 0);
