...
--
-- Servidor: localhost
-- Tiempo de generación: 18-12-2014 a las 22:22:54
...
--
-- Volcado de datos para la tabla `cv_detallefacturasaux`
--

INSERT INTO `cv_detallefacturasaux` (`idauxdetallefactura`, `refcliente`, `refproducto`, `precioventa`, `cantidad`, `temporal`, `activo`) VALUES
(1, 9, 4, '0', 2, '2014-12-18 01:18:26', b'1'),
(2, 9, 7, '0', 4, '2014-12-18 01:38:49', b'1'),
(7, 9, 10, '0', 6, '2014-12-18 04:28:37', b'1'),
(8, 9, 7, '0', 6, '2014-12-18 04:31:04', b'1');
...
CREATE TABLE IF NOT EXISTS `cv_pedidos` (
  ...
  `usuarcrea` varchar(45) DEFAULT NULL,
